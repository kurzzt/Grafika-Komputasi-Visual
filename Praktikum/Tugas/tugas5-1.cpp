...
Nama		: Dian Pagita
NIM			: 24060121130092
Deskripsi	: Membentuk kubus dengan tesktur yang berbeda di setiap sisinya
*/
...
void initRendering() {
	...
	Image* image = loadBMP("pict1.bmp");
	_textureId = loadTexture(image);
	
	Image* image1 = loadBMP("pict2.bmp");
	_textureId1 = loadTexture(image1);
	
	Image* image2 = loadBMP("pict3.bmp");
	_textureId2 = loadTexture(image2);
	
	Image* image3 = loadBMP("pict4.bmp");
	_textureId3 = loadTexture(image3);
	
	Image* image4 = loadBMP("pict5.bmp");
	_textureId4 = loadTexture(image4);
	
	Image* image5 = loadBMP("pict6.bmp");
