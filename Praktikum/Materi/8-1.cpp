/*
PRAKTIKUM 8
Deskripsi : Membuat objek 3D bergerak statis yang memiliki bayangan
*/
...
float n[] = { 0.0, -40.0, 0.0 }; //normal vector/arah bayangan
float e[] = { 0.0, -60.0, 0.0 }; //dasar letak bayangan objek
void help();
...
void draw(){
	...
	//Isi dengan salah satu saja, dan berilah obyek yang selain dalam tabel ini
...
void glShadowProjection(float * l, float * e, float * n){ //matriks yg akan digunakan untuk proyeksi byngan
	float d, c;
	float mat[16];
...
void render(){
	glClearColor(0.0,0.6,0.9,0.0); //warna background gambar
