/*
PRAKTIKUM 7
Deskripsi : Membuat kubus 3D dengan tekstur berupa gambar
*/
...
void initRendering() {
	...
	Image* image = loadBMP("satukalisatu.bmp");
...
void drawScene() {
	...
	GLfloat lightPos[] = {-2 * BOX_SIZE, BOX_SIZE, 4 * BOX_SIZE, 1.0f}; //setting posisi cahaya
