/*
PRAKTIKUM 9
Deskripsi : membuat 2 objek 3D yang dapat berinteraksi yaitu melakukan tendangan
*/
...
void init(void){
	glEnable (GL_DEPTH_TEST); //mengaktifkan buffer
	glPolygonMode(GL_FRONT_AND_BACK, GL_FILL); //mengaktifkan poligon
